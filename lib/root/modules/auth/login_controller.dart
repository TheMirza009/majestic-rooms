...
class LoginController extends GetxController {
  ...
  Future<void> _signInWithEmail() async {
    ...
    try {
      ...
      Navigator.pushAndRemoveUntil(Get.context!, CupertinoPageRoute(builder: (_) => const HomeScreen()), (route) => false);
      ...
      Utils.showBottomSnackBarError('Sign In Failed', 'An unexpected error occurred.');
    } finally {
