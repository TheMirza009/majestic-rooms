...
class LoginScreen extends GetView<LoginController> {
  ...
  static const _btnTextDark  = TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w500,
    color: CustomColors.textDark,
  );
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() => SizedBox(
                  ...
                  child: CustomButton(
                    text: controller.isLoading.value ? 'Signing in...' : 'Sign in with Email',
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () => Navigator.push(context, CupertinoPageRoute(builder: (_) => SignupScreen())),
                      child: const Text(
                        'Sign Up',
                        style: TextStyle(
