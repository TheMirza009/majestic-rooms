const Map<String, String> arSA = {
  ...
  'Concierge': 'بواب',
  'Standard terms and conditions apply.': 'تطبق الشروط والأحكام القياسية.',
  'Prayer Room': 'مصلى',
  ...
  'Standard Room': 'غرفة قياسية',
  'Room': 'غرفة',
  'bed_count': '@count سرير',
  'beds_count': '@count أسرة',
  ...
  'Go to Bookings': 'انتقل إلى الحجوزات',
  'Back to Exploring': 'العودة للاستكشاف',
  'Saving...': 'جاري الحفظ...',
  'Booking Summary': 'ملخص الحجز',
  'room_count': '@count غرفة',
  'rooms_count': '@count غرف',
  ...
  'Occupancy taxes': 'ضرائب الإشغال',
  'Total': 'الإجمالي',
  'rooms_nights_calc': '@rooms غرفة/غرف × @nights ليلة/ليالي',
  'Tap to select': 'اضغط للتحديد',
  'From': 'من',
  'To': 'إلى',
