...
class CustomColors {
  ...
  // ── Brand tones ───────────────────────────────────────────────────────────
  static const Color primaryDark   = Color(0xFF111111); // main backgrounds / headers
  static const Color luxuryGold    = Color(0xFFD4AF37); // accents, active states, stars
  static const Color premiumAmber  = Color(0xFFC5A059); // border outlines, secondary buttons
  ...
  static const Color cardSubtleBg  = Color(0xFFF1F1F3); // secondary cards / dividers
